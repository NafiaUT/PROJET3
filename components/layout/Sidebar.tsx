...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView }) => {
  ...
  const navItems = [
    { view: View.DASHBOARD, label: 'Tableau de bord', icon: DashboardIcon },
    { view: View.ANALYTICS, label: 'Analyse', icon: AnalyticsIcon },
  ];
  ...
  return (
    <div className="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col">
      ...
      <div className="px-2 py-4 border-t border-gray-200 dark:border-gray-700">
        <button
          onClick={logout}
          className="w-full flex items-center px-4 py-2 text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900 rounded-md transition-colors duration-150"
        >
