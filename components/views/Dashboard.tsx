...
import { LampIcon, ThermostatIcon, MotionSensorIcon, AmbientSensorIcon, WindowIcon } from '../../utils/icons';
...
/**
 * Renders a device-specific control card with the appropriate control surface.
 */
...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-200">Tableau de bord</h2>
